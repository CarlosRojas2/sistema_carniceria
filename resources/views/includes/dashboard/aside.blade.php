<div class="main-sidebar main-sidebar-sticky side-menu">
    <div class="sidemenu-logo">
        <a class="main-logo" href="{{asset('/index.html')}}">
        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <ul class="nav-sub">
                    ...
                    <li class="nav-sub-item">
                        <a class="nav-sub-link" href="{{asset('/icons02.html')}}">Material Design Icons</a>
                    </li>
                    <li class="nav-sub-item">
                        <a class="nav-sub-link" href="{{asset('/icons03.html')}}">Simple Line Icons</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                ...
                <ul class="nav-sub">
                    <li class="nav-sub-item">
                        <a class="nav-sub-link" href="/{{asset('tablebasic.html')}}">Basic Tables</a>
                    </li>
                    <li class="nav-sub-item">
                        <a class="nav-sub-link" href="{{asset('/tabledata.html')}}">Data Tables</a>
                    </li>
                </ul>
            </li>
        </ul>
